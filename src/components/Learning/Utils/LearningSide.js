...
function LearningSide({ id, tab }) {
    ...
    return (
        <div
            id="side"
            className={
                !sideBar ? "col-lg-2 learningside" : "col-lg-12 learningside2"
            }
        >
            ...
            <Link to={`/learn/${id}/syllabus`} className="btn-width">
                ...
                <button
                    className={
                        active === "syllabus" ? "learningside__active" : null
                    }
                >
                    Syllabus
                </button>
            ...
            <Link to={`/learn/${id}/leaderboard`} className="btn-width">
                <button
                    className={
                        active === "progress" ? "learningside__active" : null
                    }
                >
                    Progress
                </button>
            ...
            <Link to={`/learn/${id}/bookmark`} className="btn-width">
                ...
                <button
                    className={
                        active === "bookmark" ? "learningside__active" : null
                    }
                >
                    Bookmark
                </button>
