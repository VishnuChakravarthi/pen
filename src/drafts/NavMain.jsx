          ...
          <div className="container-fluid">
            <nav className="d-flex align-items-baseline justify-content-between">
                    ...
                    <div className="header_top_lang_widget">
                      <div className="ht-widget-container">
                        <div className="vertical-wrapper">
                          <h2 className="title-vertical home3" id="library">
              ...
              <li className="list_three list-style-none">
                <a onClick={redirect}>
                  <span className="titles titles-1" data-redirect="/learnfree">
                    Learn For Free
                  </span>
                </a>
              </li>
              ...
              <li className="list-_five list-style-none">
                <a href="/giveandtake">
                  <span className="titles titles-1">Give And Take</span>
                </a>
              </li>
              ...
              <li className="list_two list-style-none">
                <a onClick={redirect}>
                  <span className="titles titles-1" data-redirect="/freecourse">
                    {" "}
                    All Courses
                  </span>
                </a>
              ...
              <li className="list_one list-style-none">
                <a href="/">
                  <span className="titles titles-1">Home</span>
                </a>
              </li>

              <li className="list-_five list-style-none">
                <a href="/feedback">
                  <span className="titles titles-1">Reach Us</span>
                </a>
              </li>
