...
function Navbar() {
  ...
  return (
    <React.Fragment>
          ...
          <div className="container-fluid">
            <nav className="d-flex align-items-baseline justify-content-between">
                    ...
                    <div className="header_top_lang_widget">
                      <div className="ht-widget-container">
                        <div className="vertical-wrapper">
                          <h2 className="title-vertical home3">
                            <span className="text-title">Library</span>{" "}
                            <i
              ...
              <li className="list-_five list-style-none">
                <a href="/giveandtake">
                  <span className="titles color-fff">Give And Take</span>
                </a>
              </li>

              <a
                href="#"
                className="navbar_brand mt-0 dn-smd align-self-center"
                style={{ marginLeft: "6%" }}
              >
                <img
              ...
              <li className="list_one list-style-none">
                <a href="/">
                  <span className="titles  color-fff">Home</span>
                </a>
              </li>

              <li className="list-_five list-style-none">
                <a href="/feedback">
                  <span className="titles  color-fff">Reach Us</span>
                </a>
              </li>
              <li className="list_four list-style-none">
                <a
                  href=""
                  className="btn-md"
                  data-toggle="modal"
                  data-target="#exampleModalCenter"
                >
                  <i className="flaticon-user titles color-fff"></i>{" "}
                  {/* <span className="dn-md titles ">Login/Register</span> */}
                </a>
              </li>
              <li className="last list-style-none">
                <a
                  href=""
                  className="btn p-0 cart_btn flaticon-shopping-bag titles"
                  style={{ fontSize: "20px" }}
                >
                ...
                <div className="login_form">
                  <form action="#">
                    ...
                    <div className="form-group form-check">
                      ...
                      <a className="tdu text-thm float-right" href="#">
                        Forgot Password?
                      </a>
                    </div>
                    <button
      ...
      <div
        id="page"
        className="stylehome1 home3 h0"
        style={{ background: "#606470 !important" }}
      >
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="page-event-single.html">Event Single</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="page-my-courses.html">My Courses</a>
                    </li>
                    <li>
                      <a href="page-my-order.html">My Order</a>
                    </li>
                    <li>
                      <a href="page-my-message.html">My Message</a>
                    </li>
                    <li>
                      <a href="page-my-review.html">My Review</a>
                    </li>
                    <li>
                      <a href="page-my-bookmarks.html">My Bookmarks</a>
                    </li>
                    <li>
                      <a href="page-my-listing.html">My Listing</a>
                    </li>
                    <li>
                      <a href="page-my-setting.html">My Setting</a>
                    </li>
                  </ul>
                </li>
                <li>
                ...
                <li>
                  <a href="page-become-instructor.html">Become an Instructor</a>
                </li>
                <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="page-blog-list.html">Blog List 3</a>
                </li>
                <li>
