...
$(window).scroll(function () {
    if ($(window).scrollTop() > elementPosition.top) {
        ...
        $("#Logo").attr("src", "/images/blue.png");
        $(".title-vertical.home3").css("backgroundColor", "#00b0f0");
        $(".title-vertical.home3").css("color", "black");
    } else {
...
$(window).scroll(function () {
    if ($(window).scrollTop() > elementPosition.top) {
        ...
        // $("#Logo").attr("src", "/images/blue.png");
        $("#library").css("backgroundColor", "#00b0f0");
        $("#library").css("color", "black");
    } else {
        $("#navigation2").css("position", "static");

        document.querySelectorAll(".titles").forEach((item) => {
            item.style.color = "white";
        });
        // $("#Logo").attr("src", "/images/white.png");
        $("#library").css("backgroundColor", "#00b0f0").css("color", "black");
    }
});
